...
adaptters we see an opportunity to utilize **GPU Compute** for maximizing performance of simulation.
...
• **Data oriented by default**, everything is stored by type where you can reason on data access to improve
performance.
